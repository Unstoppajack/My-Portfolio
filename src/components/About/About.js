...
function About() {
  return (
    <Container className='p-5 '>
      ...
      <Accordion.Item eventKey="0" style={{backgroundColor:'black', color:'white', paddingBottom:'10px'}}>
      ...
      <Accordion.Item eventKey="1" style={{backgroundColor:'black', color:'white', paddingBottom:'10px'}}>
        <Accordion.Header>School 2 | Year 2019</Accordion.Header>
        <Accordion.Body>
        Daniel maramba national highschool, Poblacion norte sta barbara   
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="2" style={{backgroundColor:'black', color:'white', paddingBottom:'10px'}}>  
